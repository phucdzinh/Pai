...
from PySide6.QtCore import Qt, Signal, QPoint, QRect, QRectF, QTimer, QPropertyAnimation, QEasingCurve

from pynput.keyboard import Key, Listener as KeyboardListener
from pynput.mouse import Listener as MouseListener

from core import VietnameseEngine
...
class VietnameseTypingGUI(QMainWindow):
    ...
    def apply_settings(self):
        method = "TELEX" if self.telex_rb.isChecked() else "VNI"
        self.engine = VietnameseEngine(input_method=method, charset=self.charset_combo.currentText())
